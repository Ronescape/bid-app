    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent mb-2">CoinBid</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          ...
          {apiError && (
            <div className="mt-3 p-3 bg-red-500/10 border border-red-500/30 rounded-lg">
              ...
              <p className="text-slate-400 text-xs mt-1">Using local data. Some features may be limited.</p>
            </div>
          )}
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-4 gap-1 py-2">
            {navItems.map(({ id, icon: Icon, label }) => (
              <Button key={id} variant="ghost" onClick={() => setCurrentView(id as View)} className={`flex flex-col items-center gap-1 h-auto py-2 transition-all ${currentView === id ? getActiveStyle(id) : "text-slate-400 hover:text-purple-400 hover:bg-white/10"}`}>
